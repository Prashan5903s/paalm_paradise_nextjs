...
// Component Imports
import ParkingDialog from '@components/dialogs/parking-dialog/page';
...
const ParkingCards = ({ fetchZoneData, tableData }) => {
    ...
    <Grid container spacing={6}>
                ...
                <div className='flex flex-col items-start gap-1'>
                  ...
                  <OpenDialogOnElementClick
                    ...
                    dialog={({ open, setOpen, tableData }) => (
                      <ParkingDialog open={open} setOpen={setOpen} title={item.title} fetchZoneData={fetchZoneData} tableData={tableData} />
                    )}
                  />
                </div>
      ...
      <Grid xs={12} sm={6} lg={4}>
        <OpenDialogOnElementClick
          ...
          dialog={({ open, setOpen }) => (
            <ParkingDialog open={open} setOpen={setOpen} fetchZoneData={fetchZoneData} tableData={tableData} />
          )}
        />
      </Grid>
      {/* )} */}
